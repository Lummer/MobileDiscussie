...
#if WINDOWS8
using Device.Serializer.SharpSerializer.Library.W8;
using System.Linq;
#endif
namespace Polenter.Serialization.Advanced
{
    ...
    public class PropertyProvider
    {
            ...
            System.Reflection.TypeInfo typeInfo)
        {
			...
			var cacheKey = typeInfo.AsType();

            if (_cache.ContainsKey(cacheKey)) return _cache[cacheKey];
            // Creating infos
            PropertyInfo[] properties = GetAllProperties(cacheKey);
        ...
        ///   - is indexer
        /// </returns>
        protected virtual bool IgnoreProperty( 
                ...
                info, PropertyInfo property)
        {
            ...
            if (PropertiesToIgnore.Contains(type, property.Name))
            {
                return true;
            }
        ...
        protected bool ContainsExcludeFromSerializationAttribute(PropertyInfo property)
        {
            ...
            {
#if WINDOWS8
                object[] attributes = property.GetCustomAttributes(attrType, false).ToArray();
#else
