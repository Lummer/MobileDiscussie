...
namespace Polenter.Serialization.Core
{
    ...
    internal static class Tools
    {
...
#if WINDOWS8
            if (type == typeof(Type) || type.GetTypeInfo().IsAssignableFrom(typeof(Type).GetTypeInfo()))
#else
...
#if WINDOWS8
            return referenceType.GetTypeInfo().IsAssignableFrom(type.GetTypeInfo());
#else
        ...
        {
#if WINDOWS8
            var reftype = typeof(IDictionary<object, object>);
            return reftype.GetTypeInfo().IsAssignableFrom(type.GetTypeInfo());
#else
