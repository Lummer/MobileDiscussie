...
namespace Polenter.Serialization.Core
{
...
#if WINDOWS8
            string type = Type == null ? "null" : Type.GetTypeInfo().Name;
            string parent = Parent == null ? "null" : Parent.GetType().GetTypeInfo().Name;
            return string.Format("{0}, Name={1}, Type={2}, Parent={3}", GetType().GetTypeInfo().Name, name, type, parent);
#else
    ...
    public sealed class ReferenceInfo
    {
        ...
        {
#if WINDOWS8
            return string.Format("{0}, Count={1}, Id={2}, IsProcessed={3}", GetType().GetTypeInfo().Name, Count, Id, IsProcessed);
#else
